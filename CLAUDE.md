...
- `skills-writer` — **Load before editing any skill's `SKILL.md`.** Map-and-landmines philosophy, the 20% damped-growth rule (incl. landmine/bimodal-fission/converging-pull exceptions), the cut test, and the approval-before-writing gate
